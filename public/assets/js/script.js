(function ($) {
  ...
  $(add_button).click(function (e) { //on add input button click
    ...
    if (x < max_fields) { //max input box allowed
      ...
      $(wrapper).append('<div class="mb-3 repeat_form"><form><div class="row align-items-end"><div class="col-md-4"><label class="form-label" for="">اختيارات</label><select class="js-example-basic-single"><optgroup label=""><option value="0">اختيار 1</option><option value="1">اختيار 2</option></optgroup></select></div><div class="col-md-4"><label class="form-label" for="">من</label><input class="form-control" id="" type="time" value="" required=""></div><div class="col-md-4"><label class="form-label" for="">الي</label><input class="form-control" id="" type="time" value="" required=""></div></form></div> <a href="#" class="remove_field btn btn-danger m-l-20">Remove</a>'); //add input box
    }
  ...
  $(wrapper).on("click", ".remove_field", function (e) { //user click on remove text
    ...
    var max_fields = 10; //maximum input boxes allowed
    var wrapper = $(".input_fields_wrap"); //Fields wrapper
    var add_button = $(".add_offer"); //Add button ID
